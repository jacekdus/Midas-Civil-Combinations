...
g1 = LoadCase('G1', 'CS')
g1_sls = LoadCombination('G1_SLS', [[g1, 1.00]])

g1_str_max = LoadCombination('G1_STR_MAX', [[g1, 1.35]])
g1_str_min = LoadCombination('G1_STR_MIN', [[g1, 1.00]])

g2_kapy = LoadCase('G2_KAPY', 'CS')
g2_nawierz = LoadCase('G2_NAWIERZ', 'CS')
g2_izol = LoadCase('G2_IZOL', 'CS')

g2_sls_max = LoadCombination('G2_SLS_MAX', [[g2_kapy, 1.00], [g2_nawierz, 1.40], [g2_izol, 1.40]])
g2_sls_min = LoadCombination('G2_SLS_MIN', [[g2_kapy, 1.00], [g2_nawierz, 0.80], [g2_izol, 0.80]])

g2_str_max = LoadCombination('G2_STR_MAX', [[g2_kapy, 1.35], [g2_nawierz, 1.89], [g2_izol, 1.89]])
g2_str_min = LoadCombination('G2_STR_MIN', [[g2_kapy, 1.00], [g2_nawierz, 0.80], [g2_izol, 0.80]])
...
creep_primary = LoadCase('Creep Primary', 'CS')
creep_secondary = LoadCase('Creep Secondary', 'CS')

crp_sls = LoadCombination('CRP_SLS', [[creep_secondary, 1.00]])

crp_str_max = LoadCombination('CRP_STR_MAX', [[creep_secondary, 1.35]])
crp_str_min = LoadCombination('CRP_STR_MIN', [[creep_secondary, 1.00]])

shrinkage_primary = LoadCase('Shrinkage Primary', 'CS')
shrinkage_secondary = LoadCase('Shrinkage Secondary', 'CS')

shr_sls = LoadCombination('SHR_SLS', [[shrinkage_secondary, 1.00]])

shr_str_max = LoadCombination('SHR_STR_MAX', [[shrinkage_secondary, 1.35]])
shr_str_min = LoadCombination('SHR_STR_MIN', [[shrinkage_secondary, 1.00]])

zerowanie = LoadCase('ZEROWANIE')
lm1_l_psi = LoadCase('LM1_L#PSI', 'MV')
lm1_p_psi = LoadCase('LM1_P#PSI', 'MV')
q_gr2_lm1_comb = LoadCombination('Q_gr2_LM1_COMB', [[lm1_l_psi, 1.00], [lm1_p_psi, 1.00]], envelop=True)
...
q_gr2_cf_comb = LoadCombination('Q_gr2_CF_COMB', [
    [ods_1, 1.00], [ods_2, 1.00],
    [ods_3, 1.00], [ods_4, 1.00],
    [ods_5, 1.00], [ods_6, 1.00]
], envelop=True)

lm1_l = LoadCase('LM1_L', 'MV')
lm1_p = LoadCase('LM1_P', 'MV')
q_gr1a_comb = LoadCombination('Q_gr1a_COMB', [[lm1_l, 1.00], [lm1_p, 1.00]], envelop=True)
q_gr1a_psi_comb = LoadCombination('Q_gr1a_psi_COMB', [[lm1_l_psi, 1.00], [lm1_p_psi, 1.00]], envelop=True)
...
q_gr5_comb = LoadCombination('Q_gr5_COMB', [[mlc_x1, 1.00], [mlc_x2, 1.00]], envelop=True)

q2k = LoadCase('Q2k', 'MV')
q2k_comb = LoadCombination('Q2k_comb', [[q2k, 1.00]])
...
g1_sls_comb = LoadCombination('G1_SLS_COMB', [[g1_sls, 1.00]])
g2_sls_comb = LoadCombination('G2_SLS_COMB', [[g2_sls_max, 1.00], [g2_sls_min, 1.00]], envelop=True)

ps_sls_comb = LoadCombination('PS_SLS_COMB', [[tendon_primary, 1.00], [tendon_secondary, 1.00]])

crp_sls_comb = LoadCombination('CRP_SLS_COMB', [[crp_sls, 1.00]])
shr_sls_comb = LoadCombination('SHR_SLS_COMB', [[shr_sls, 1.00]])

q_ch_comb = LoadCombination('Q_CH_COMB', [[q_gr1a_comb, 1.00],
                                          [q_gr2_comb, 1.00],
                                          [q_gr5_comb, 1.00]], envelop=True)
q_fr_comb = LoadCombination('Q_FR_COMB', [[q_gr1a_psi_comb, 1.00]])
...
q_acc_comb = LoadCombination('Q_ACC_COMB', [[q_acc_1_comb, 1.00], [q_acc_2_comb, 1.00]], envelop=True)

g1_str_comb = LoadCombination('G1_STR_COMB', [[g1_str_max, 1.00], [g1_str_min, 1.00]], envelop=True)
g2_str_comb = LoadCombination('G2_STR_COMB', [[g2_str_max, 1.00], [g2_str_min, 1.00]], envelop=True)

ps_str_comb = LoadCombination('PS_STR_COMB', [[ps_str_max, 1.00], [ps_str_min, 1.00]], envelop=True)

crp_str_comb = LoadCombination('CRP_STR_COMB', [[crp_str_max, 1.00], [crp_str_min, 1.00]], envelop=True)
shr_str_comb = LoadCombination('SHR_STR_COMB', [[shr_str_max, 1.00], [shr_str_min, 1.00]], envelop=True)

q_str_comb = LoadCombination('Q_CH_COMB', [[q_gr1a_comb, 1.35],
                                           [q_gr2_comb, 1.35],
                                           [q_gr5_comb, 1.35]], envelop=True)

ch_comb = LoadCombination('CH_COMB', [
    [g1_sls_comb, 1.00], [g2_sls_comb, 1.00], [ps_sls_comb, 1.00],
    [crp_sls_comb, 1.00], [shr_sls_comb, 1.00], [q_ch_comb, 1.00]
])

fr_comb = LoadCombination('FR_COMB', [
    [g1_sls_comb, 1.00], [g2_sls_comb, 1.00], [ps_sls_comb, 1.00],
    [crp_sls_comb, 1.00], [shr_sls_comb, 1.00], [q_fr_comb, 1.00]
])

qp_comb = LoadCombination('QP_COMB', [
    [g1_sls_comb, 1.00], [g2_sls_comb, 1.00], [ps_sls_comb, 1.00],
    [crp_sls_comb, 1.00], [shr_sls_comb, 1.00]
])
...
acc_comb = LoadCombination('ACC_COMB', [
    [g1_sls_comb, 1.00], [g2_sls_comb, 1.00], [ps_str_comb, 1.00],
    [crp_sls_comb, 1.00], [shr_sls_comb, 1.00], [q_acc_comb, 1.00], [accidental, 1.00]
])
