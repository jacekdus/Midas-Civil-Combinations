...
dg_izolacja08 = LoadCase('dg_izolacja', 'CS')
...
dg_naw_komb = LoadCombination('dg_naw_komb', [
    [dg_nawierzchnia08, 0.8],
    [dg_nawierzchnia0140, 1.4],
], envelop=True)
...
Q_ch_1b = LoadCombination('Q_ch_1b', [
    [gr1b, 1.0],
    [temp_komb, 0.6]
], envelop=False)
...
QUASI_STALA_komb = LoadCombination('QUASI-STALA_komb', [
    [G_ch_komb, 1.0],
    [temp_komb, 0.5],
], envelop=False)
